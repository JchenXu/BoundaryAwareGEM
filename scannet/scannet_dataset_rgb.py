...
class ScannetDataset():
    def __init__(self, root, block_points=8192, split='train', with_rgb=False):
        ...
        print(self.scene_points_list[0].shape)
        print(self.semantic_labels_list[0].shape)
        print(self.scene_points_id[0].shape)
        print(len(self.scene_points_num))
        if split == 'train':
...
if __name__ == '__main__':
    TRAIN_DATASET = ScannetDataset(root='./', block_points=8192, split='train')
